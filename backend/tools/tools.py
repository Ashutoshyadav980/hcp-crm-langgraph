...
def extract_interaction_with_llm(text: str) -> dict:
    ...
    - follow_up_date: YYYY-MM-DD format. Calculate from expressions relative to today's date (today is {datetime.date.today().isoformat()}, today weekday is {datetime.date.today().strftime('%A')}). E.g., "next Tuesday" or "next Friday" or "after 10 days".
    - notes: Extra details.
